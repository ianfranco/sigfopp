...
@FacesConverter(value = "jornadaLaboralConverter")
public class JornadaLaboralConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof JornadaLaboral) {
            ...
            return getStringKey(o.getJornadaLaboralId());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), JornadaLaboral.class.getName()});
            return null;
        }
    }
