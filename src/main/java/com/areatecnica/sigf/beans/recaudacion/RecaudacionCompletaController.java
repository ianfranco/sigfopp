...
import com.areatecnica.sigf.sockets.RecaudacionNotify;
 ...
 * FIN OBSERVACIONES ***
 */
public class RecaudacionCompletaController extends AbstractCrudController<Recaudacion> implements IProcess {

    /*Inyección de Controladores*/
    @Inject
    private RecaudacionNotify notify;
    @Inject
    private RecaudacionGeneralController recaudacionGeneralController;
    @Inject
    ...
    private RecaudacionExtra recaudacionExtra;
     ...
     */
    public RecaudacionCompletaController() {
     ...
     * @return the notify
     */
    public RecaudacionNotify getNotify() {
        return notify;
    }
     ...
     */
    public void setNotify(RecaudacionNotify notify) {
        this.notify = notify;
    }

    /**
     * @return the inventarioCajaItems
     */
    ...
    /**
     * @param inventarioCajaItems the inventarioCajaItems to set
     */
    ...
    /**
     * @return the boletosMap
     */
    public Map getBoletosMap() {
        return boletosMap;
    }

    /**
     * @param boletosMap the boletosMap to set
     */
    public void setBoletosMap(Map boletosMap) {
        this.boletosMap = boletosMap;
    }
    ...
    /**
     * @return the recaudacionExtra
     */
    public RecaudacionExtra getRecaudacionExtra() {
        return recaudacionExtra;
    }

    /**
     * @param recaudacionExtra the recaudacionExtra to set
     */
    public void setRecaudacionExtra(RecaudacionExtra recaudacionExtra) {
        this.recaudacionExtra = recaudacionExtra;
    }
    ...
    @Override
    public void load() {
        /*this.recaudacionGeneralController.init();
        this.recaudacionGeneralController.setCajaRecaudacion(this.cajaRecaudacion);
        this.recaudacionGeneralController.setFechaRecaudacion(this.fechaRecaudacion);
        this.recaudacionGeneralController.load();
        System.err.println("acciona caja:" + this.recaudacionGeneralController.getCajaRecaudacion() + "Fecha:" + this.recaudacionGeneralController.getFechaRecaudacion());
         */
    ...
    public void load2() {
        ...
        this.setInventarioCajaItems((List<InventarioCaja>) this.inventarioCajaDao.findByEstado(Boolean.FALSE, this.getUserCount()));

        setBoletosMap(new HashMap());

        for (InventarioCaja ic : this.getInventarioCajaItems()) {
            if (getBoletosMap().containsKey(ic.getInventarioCajaIdInventarioInterno().getInventarioInternoIdBoleto().getBoletoNombre())) {
                int count = (int) getBoletosMap().get(ic.getInventarioCajaIdInventarioInterno().getInventarioInternoIdBoleto().getBoletoNombre());
                getBoletosMap().put(ic.getInventarioCajaIdInventarioInterno().getInventarioInternoIdBoleto().getBoletoNombre(), count + 1);
            } else {
                getBoletosMap().put(ic.getInventarioCajaIdInventarioInterno().getInventarioInternoIdBoleto().getBoletoNombre(), 1);
            }
        }
    ...
    public RecaudacionCombustible prepareCreateRecaudacionCombustible(ActionEvent event) {
        super.prepareCreate(event); //To change body of generated methods, choose Tools | Templates.

        this.recaudacionCombustible = new RecaudacionCombustible();
        this.setSelected(new Recaudacion());
        this.recaudacionCombustible.setRecaudacionCombustibleIdRecaudacion(this.getSelected());

        this.getSelected().setRecaudacionFecha(fechaRecaudacion);
        this.getSelected().setRecaudacionIdCaja(cajaRecaudacion);

        return this.recaudacionCombustible;
    }

    public RecaudacionExtra prepareCreateRecaudacionExtra(ActionEvent event) {

        this.recaudacionExtra = new RecaudacionExtra();
        this.setSelected(new Recaudacion());
        this.recaudacionExtra.setRecaudacionExtraIdRecaudacion(this.getSelected());

        this.getSelected().setRecaudacionFecha(fechaRecaudacion);
        this.getSelected().setRecaudacionIdCaja(cajaRecaudacion);

        return this.recaudacionExtra;
    }
    ...
    public void saveNewRecaudacionCombustible(ActionEvent event) {
    ...
    public void handleBoletaChange() {
        if (this.getSelected().getRecaudacionIdentificador() > 0) {
            this.ventaCombustibleDao = new IVentaCombustibleDaoImpl();
            this.setVentaCombustible(this.ventaCombustibleDao.findByBoleta(this.getSelected().getRecaudacionIdentificador()));

            if (this.getVentaCombustible() != null) {

                if (!this.getVentaCombustible().getVentaCombustibleRecaudado()) {
                    this.getSelected().setRecaudacionIdBus(this.getVentaCombustible().getVentaCombustibleIdBus());
                    this.getSelected().setRecaudacionTotal(getVentaCombustible().getVentaCombustibleTotal());
                    this.getRecaudacionCombustible().setRecaudacionCombustibleIdVentaCombustible(getVentaCombustible());
                    this.getRecaudacionCombustible().setRecaudacionCombustibleMonto(getVentaCombustible().getVentaCombustibleTotal());
                } else {
