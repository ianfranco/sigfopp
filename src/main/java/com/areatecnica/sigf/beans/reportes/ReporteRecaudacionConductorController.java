 ...
 * FIN OBSERVACIONES ***
 */
public class ReporteRecaudacionConductorController extends AbstractCrudController<Recaudacion> implements IProcess {
    ...
    private List<Trabajador> conductorItems;
     ...
     */
    public ReporteRecaudacionConductorController() {
    ...
    public void init() {
        ...
        this.conductorItems = this.trabajadorDao.findByTerminal(this.getCurrentUser().getUsuarioIdTerminal());
    ...
    /**
     * @param trabajador conductorItems to set
     */
    ...
    /**
     * @return the conductorItems
     */
    public List<Trabajador> getConductorItems() {
        return conductorItems;
    }

    /**
     * @param conductorItems the conductorItems to set
     */
    public void setConductorItems(List<Trabajador> conductorItems) {
        this.conductorItems = conductorItems;
    }
    ...
    public void load() {
        ...
        this.setItems(this.recaudacionDao.findByTrabajadorBetweenFechaRecaudacion(this.trabajador, cd.date(), cd.getMaxDate()));
    ...
    private class ReportCustomizer extends DefaultAdhocReportCustomizer {
        ...
        public void customize(ReportBuilder<?> report, AdhocReport adhocReport) throws DRException {
            ...
            report.title(Templates.createTitleComponent("Producción Conductor N°:" + trabajador.getTrabajadorCodigo() + " al :" + currentDate.format(fechaRecaudacion)));
